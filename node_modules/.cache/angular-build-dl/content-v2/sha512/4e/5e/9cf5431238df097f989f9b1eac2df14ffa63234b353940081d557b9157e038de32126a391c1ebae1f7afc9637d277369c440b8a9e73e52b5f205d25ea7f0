...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MediaServiceService", function() { return MediaServiceService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let MediaServiceService = class MediaServiceService {
    ...
    takePicture() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                const profilePicture = yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Camera"].getPhoto({
                    quality: 90,
                    allowEditing: false,
    ...
    uploadProfile(id) {
        ...
        task.on('state_changed', function (snap) {
            ...
            switch (snap.state) {
                case firebase__WEBPACK_IMPORTED_MODULE_4__["storage"].TaskState.ERROR: // or 'paused'
                    console.log('Upload is wee');
                    break;
                case firebase__WEBPACK_IMPORTED_MODULE_4__["storage"].TaskState.RUNNING: // or 'running'
                    console.log('Upload is running');
                    break;
            }
        }, function (error) { this.showToast("No se ha subido nada"); }, function () { });
    ...
    getProfilePhoto(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            console.log(task);
            yield task.getDownloadURL().then((downloadURL) => {
...
MediaServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
//# sourceMappingURL=default~home-home-module~pages-comentarios-sugerencias-comentarios-sugerencias-module~pages-perfil-p~027469d5-es2015.js.map