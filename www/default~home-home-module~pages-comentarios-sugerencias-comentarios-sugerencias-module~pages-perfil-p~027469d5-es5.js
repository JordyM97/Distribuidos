...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~home-home-module~pages-comentarios-sugerencias-comentarios-sugerencias-module~pages-perfil-p~027469d5"], {
  /***/
  ...
  /*! exports provided: MediaServiceService */

  /***/
  function srcAppServicesMediaServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MediaServiceService", function () {
    ...
    var MediaServiceService = /*#__PURE__*/function () {
      function MediaServiceService(toastCtrl) {
        _classCallCheck(this, MediaServiceService);

        this.toastCtrl = toastCtrl;
        this.storageRef = firebase__WEBPACK_IMPORTED_MODULE_4__["storage"]().ref();
      }

      _createClass(MediaServiceService, [{
        key: "takePicture",
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 7:
                    ...
                    console.error("Take pic" + JSON.stringify(_context.t0));
        ...
        key: "uploadProfile",
        value: function uploadProfile(id) {
          var _this2 = this;

          var metadata = {
            contentType: 'image/jpeg'
          };
          var task = this.storageRef.child("profile/".concat(id, "/profile.jpg")).putString(this.picture, 'base64');
          task.on('state_changed', function (snap) {
            this.uploadProgress = snap.bytesTransferred / snap.totalBytes * 100;
            console.log('Upload is ' + this.uploadProgress + '% done');

            switch (snap.state) {
              case firebase__WEBPACK_IMPORTED_MODULE_4__["storage"].TaskState.ERROR:
                // or 'paused'
                console.log('Upload is wee');
                break;

              case firebase__WEBPACK_IMPORTED_MODULE_4__["storage"].TaskState.RUNNING:
                // or 'running'
                console.log('Upload is running');
                break;
            }
          }, function (error) {
            this.showToast("No se ha subido nada");
          }, function () {});
          task.snapshot.ref.getDownloadURL().then(function (downloadURL) {
            _this2.pictureview = downloadURL;
            _this2.status = 1;

            _this2.showToast("Subido Exitosamente!");

            console.log(_this2.pictureview);
          });
        ...
        value: function upload() {
          ...
          task.snapshot.ref.getDownloadURL().then(function (downloadURL) {
            _this3.pictureview = downloadURL;
            _this3.status = 1;

            _this3.showToast("Subido Exitosamente!");

            console.log(_this3.pictureview);
          });
          if (this.status = 0) this.showToast("No se ha subido nada");
        }
      }, {
        key: "getProfilePhoto",
        value: function getProfilePhoto(id) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    task = this.storageRef.child("profile/".concat(id, "/profile.jpg"));
                    console.log(task);
                    _context2.next = 4;
                    return task.getDownloadURL().then(function (downloadURL) {
                      _this4.profilephoto = downloadURL;
                      console.log(_this4.profilephoto);
                    });
    ...
    MediaServiceService.ctorParameters = function () {
      return [{
        type: _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["ToastController"]
      }];
    };

    MediaServiceService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], MediaServiceService);
    /***/
  }
}]);
//# sourceMappingURL=default~home-home-module~pages-comentarios-sugerencias-comentarios-sugerencias-module~pages-perfil-p~027469d5-es5.js.map